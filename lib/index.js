...
const num0a01 = require('./evm/precompiles/0a01-x25519key.js')
const num0a02 = require('./evm/precompiles/0a02-x25519pub.js')
...
module.exports = class VM extends AsyncEventEmitter {
  constructor (opts = {}) {
    ...
    this._precompiled['0000000000000000000000000000000000000a01'] = num0a01
    this._precompiled['0000000000000000000000000000000000000a02'] = num0a02
